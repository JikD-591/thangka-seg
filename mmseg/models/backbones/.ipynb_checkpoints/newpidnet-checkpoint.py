...
class newPIDNet(BaseModule):
    def __init__(self,
        ...
        self.COT = CAFMWithContextEnhancement(dim=256)
        # self.COT = CAFMWithContextEnhancement(dim=128)#COT模块消融
        # ModifiedPartialConv3
        # self.block128 = Partial_conv3(128, 2, 'split_cat')
        # self.block64 = Partial_conv3(64, 2, 'split_cat')
        # self.block128 = ModifiedPartialConv3(128, 2, 'split_cat')
        # self.block64 = ModifiedPartialConv3(64, 2, 'split_cat')
        # # self.block128se = PartialConv3WithSE(128, 2, 'split_cat')
        # self.block256 = Partial_conv3(256, 2, 'split_cat')
        # block = PartialConv3WithSE(64, 2, 'split_cat')
        # self.COT = CAFMWithContextEnhancement(dim=256)
        # self.MAB = MAB(128)
